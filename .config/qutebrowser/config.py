...
## list) will work.
## Type: List of String
c.qt.args = ["[ppapi-widevine-path=/usr/lib/qt5/plugins/ppapi/libwidevinecdmadapter.so]"]
...
## Type: Dict
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}', 'dict': 'https://dict.cc/?s={}', 'yt': 'https://youtube.com/results?search_query={}', 'wiki': 'https://de.wikipedia.org/w/index.php?search={}', 'g': 'https://google.com/search?q={}'}
